...
function buildMode:Init(dbFileName, buildName, buildXML, convertBuild, importLink)
	...
	self.controls.modeAI = new("ButtonControl", {"LEFT",self.controls.modeParty,"RIGHT"}, {4, 0, 50, 20}, "AI", function()
		self.viewMode = "AI"
	end)
...
function buildMode:OnFrame(inputEvents)
	...
	elseif self.viewMode == "AI" then
		self.aiTab:Draw(tabViewPort, inputEvents)
	end
